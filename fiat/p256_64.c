 ...
 * --static --use-value-barrier p256 64 '2^256 - 2^224 + 2^192 + 2^96 - 1' mul
...
/* The type fiat_p256_montgomery_domain_field_element is a field element in the
 * Montgomery domain. */
...
/* The type fiat_p256_non_montgomery_domain_field_element is a field element NOT
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_addcarryx_u64(uint64_t *out1, fiat_p256_uint1 *out2,
                        fiat_p256_uint1 arg1, uint64_t arg2, uint64_t arg3) {
 ...
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_subborrowx_u64(uint64_t *out1, fiat_p256_uint1 *out2,
                         fiat_p256_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  fiat_p256_int128 x1;
  fiat_p256_int1 x2;
  uint64_t x3;
 ...
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_mulx_u64(uint64_t *out1,
                                                     uint64_t *out2,
                                                     uint64_t arg1,
                                                     uint64_t arg2) {
  fiat_p256_uint128 x1;
 ...
 *   out1: [0x0 ~> 0xffffffffffffffff]
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_cmovznz_u64(uint64_t *out1,
 ...
 *
 */
void fiat_p256_mul(fiat_p256_montgomery_domain_field_element out1,
                   const fiat_p256_montgomery_domain_field_element arg1,
                   const fiat_p256_montgomery_domain_field_element arg2) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *
 */
void fiat_p256_square(fiat_p256_montgomery_domain_field_element out1,
                      const fiat_p256_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_add(fiat_p256_montgomery_domain_field_element out1,
              const fiat_p256_montgomery_domain_field_element arg1,
              const fiat_p256_montgomery_domain_field_element arg2) {
  uint64_t x1;
  fiat_p256_uint1 x2;
...
/*
 * The function fiat_p256_sub subtracts two field elements in the Montgomery
 * domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_sub(fiat_p256_montgomery_domain_field_element out1,
              const fiat_p256_montgomery_domain_field_element arg1,
              const fiat_p256_montgomery_domain_field_element arg2) {
  uint64_t x1;
  fiat_p256_uint1 x2;
  ...
  fiat_p256_addcarryx_u64(&x16, &x17, x15, x7,
 ...
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_opp(fiat_p256_montgomery_domain_field_element out1,
              const fiat_p256_montgomery_domain_field_element arg1) {
  uint64_t x1;
  fiat_p256_uint1 x2;
  uint64_t x3;
...
/*
 * The function fiat_p256_from_montgomery translates a field element out of the
 * Montgomery domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 *
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_from_montgomery(
    fiat_p256_non_montgomery_domain_field_element out1,
    const fiat_p256_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
...
/*
 * The function fiat_p256_to_montgomery translates a field element into the
 * Montgomery domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 *
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_to_montgomery(
    fiat_p256_montgomery_domain_field_element out1,
    const fiat_p256_non_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  fiat_p256_addcarryx_u64(&x75, &x76, x74,
  ...
  fiat_p256_addcarryx_u64(&x115, &x116, x114,
  ...
  fiat_p256_addcarryx_u64(&x155, &x156, x154,
                          (((uint64_t)x138 + x116) + (x130 + x118)), x140);
  fiat_p256_subborrowx_u64(&x157, &x158, 0x0, x149,
                           UINT64_C(0xffffffffffffffff));
  fiat_p256_subborrowx_u64(&x159, &x160, x158, x151, UINT32_C(0xffffffff));
  fiat_p256_subborrowx_u64(&x161, &x162, x160, x153, 0x0);
  fiat_p256_subborrowx_u64(&x163, &x164, x162, x155,
                           UINT64_C(0xffffffff00000001));
...
/*
 * The function fiat_p256_nonzero outputs a single non-zero word if the input is
 ...
 * ~> 0xffffffffffffffff]
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_nonzero(uint64_t *out1,
 ...
 * 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_selectznz(uint64_t out1[4],
                                                      fiat_p256_uint1 arg1,
...
/*
 * The function fiat_p256_to_bytes serializes a field element NOT in the
 ...
 * 0xff], [0x0 ~> 0xff]]
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_to_bytes(uint8_t out1[32],
                                                     const uint64_t arg1[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
...
/*
 * The function fiat_p256_from_bytes deserializes a field element NOT in the
 ...
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~>
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~>
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff]] Output Bounds: out1: [[0x0 ~>
 * 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
 * 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P256_FIAT_INLINE void fiat_p256_from_bytes(uint64_t out1[4],
...
/*
 * The function fiat_p256_set_one returns the field element one in the
 * Montgomery domain.
 *
 * Postconditions:
 ...
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_set_one(fiat_p256_montgomery_domain_field_element out1) {
  out1[0] = 0x1;
 ...
 */
static FIAT_P256_FIAT_INLINE void
fiat_p256_divstep(uint64_t *out1, uint64_t out2[5], uint64_t out3[5],
  ...
  x3 = (fiat_p256_uint1)((fiat_p256_uint1)(x1 >> 63) &
                         (fiat_p256_uint1)((arg3[0]) & 0x1));
  ...
  fiat_p256_addcarryx_u64(&x68, &x69, x67, x59,
                          (x61 & UINT64_C(0xffffffff00000001)));
...
/*
 * The function fiat_p256_divstep_precomp returns the precomputed value for
