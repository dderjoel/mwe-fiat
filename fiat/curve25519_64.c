 ...
 * --use-value-barrier 25519 64 '(auto)' '2^255 - 19' carry_mul carry_square
 * carry add sub opp selectznz to_bytes from_bytes relax carry_scmul121666 */
/* curve description: 25519 */
/* machine_wordsize = 64 (from "64") */
/* requested operations: carry_mul, carry_square, carry, add, sub, opp,
 * selectznz, to_bytes, from_bytes, relax, carry_scmul121666 */
/* n = 5 (from "(auto)") */
...
/*   eval z = z[0] + (z[1] << 51) + (z[2] << 102) + (z[3] << 153) + (z[4] <<
 * 204) */
 ...
 */
/* Bounds: [[0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~>
 ...
 */
/* Bounds: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~>
...
fiat_25519_addcarryx_u51(uint64_t *out1, fiat_25519_uint1 *out2,
                         fiat_25519_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  uint64_t x1;
  uint64_t x2;
  fiat_25519_uint1 x3;
  x1 = ((arg1 + arg2) + arg3);
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_subborrowx_u51(uint64_t *out1, fiat_25519_uint1 *out2,
                          fiat_25519_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  int64_t x1;
  fiat_25519_int1 x2;
  uint64_t x3;
 ...
 */
static FIAT_25519_FIAT_INLINE void fiat_25519_cmovznz_u64(uint64_t *out1,
...
/*
 * The function fiat_25519_carry_mul multiplies two field elements and reduces
 * the result.
 *
 * Postconditions:
 ...
 *
 */
void fiat_25519_carry_mul(fiat_25519_tight_field_element out1,
...
/*
 * The function fiat_25519_carry_square squares a field element and reduces the
 * result.
 *
 * Postconditions:
 ...
 *
 */
void fiat_25519_carry_square(fiat_25519_tight_field_element out1,
                             const fiat_25519_loose_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_carry(fiat_25519_tight_field_element out1,
                 const fiat_25519_loose_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_add(fiat_25519_loose_field_element out1,
               const fiat_25519_tight_field_element arg1,
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_sub(fiat_25519_loose_field_element out1,
               const fiat_25519_tight_field_element arg1,
               const fiat_25519_tight_field_element arg2) {
  uint64_t x1;
  uint64_t x2;
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_opp(fiat_25519_loose_field_element out1,
               const fiat_25519_tight_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_selectznz(uint64_t out1[5], fiat_25519_uint1 arg1,
...
/*
 * The function fiat_25519_to_bytes serializes a field element to bytes in
 * little-endian order.
 *
 * Postconditions:
 ...
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~>
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~>
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0x7f]]
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_to_bytes(uint8_t out1[32],
                    const fiat_25519_tight_field_element arg1) {
  uint64_t x1;
  fiat_25519_uint1 x2;
  uint64_t x3;
  ...
  uint8_t x90;
  uint8_t x91;
  fiat_25519_subborrowx_u51(&x1, &x2, 0x0, (arg1[0]),
  ...
  fiat_25519_subborrowx_u51(&x9, &x10, x8, (arg1[4]),
                            UINT64_C(0x7ffffffffffff));
  fiat_25519_cmovznz_u64(&x11, x10, 0x0, UINT64_C(0xffffffffffffffff));
  fiat_25519_addcarryx_u51(&x12, &x13, 0x0, x1,
                           (x11 & UINT64_C(0x7ffffffffffed)));
  fiat_25519_addcarryx_u51(&x14, &x15, x13, x3,
                           (x11 & UINT64_C(0x7ffffffffffff)));
  fiat_25519_addcarryx_u51(&x16, &x17, x15, x5,
                           (x11 & UINT64_C(0x7ffffffffffff)));
  fiat_25519_addcarryx_u51(&x18, &x19, x17, x7,
                           (x11 & UINT64_C(0x7ffffffffffff)));
  fiat_25519_addcarryx_u51(&x20, &x21, x19, x9,
                           (x11 & UINT64_C(0x7ffffffffffff)));
  x22 = (x20 << 4);
...
/*
 * The function fiat_25519_from_bytes deserializes a field element from bytes in
 * little-endian order.
 *
 * Postconditions:
 ...
 * 0xff], [0x0 ~> 0xff], [0x0 ~> 0x7f]]
 */
void fiat_25519_from_bytes(fiat_25519_tight_field_element out1,
...
/*
 * The function fiat_25519_relax is the identity function converting from tight
 ...
 */
static FIAT_25519_FIAT_INLINE void
fiat_25519_relax(fiat_25519_loose_field_element out1,
                 const fiat_25519_tight_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
...
/*
 * The function fiat_25519_carry_scmul_121666 multiplies a field element by
 * 121666 and reduces the result.
 *
 * Postconditions:
 *   eval out1 mod m = (121666 * eval arg1) mod m
 *
 */
FIAT_25519_FIAT_INLINE void
fiat_25519_carry_scmul_121666(fiat_25519_tight_field_element out1,
                              const fiat_25519_loose_field_element arg1) {
  fiat_25519_uint128 x1;
  fiat_25519_uint128 x2;
  fiat_25519_uint128 x3;
