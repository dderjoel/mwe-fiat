 ...
 * --use-value-barrier p521 64 9 '2^521 - 1' carry_mul carry_square carry add
 * sub opp selectznz to_bytes from_bytes relax */
...
/*   eval z = z[0] + (z[1] << 58) + (z[2] << 116) + (z[3] << 174) + (z[4] <<
 * 232) + (z[5] << 0x122) + (z[6] << 0x15c) + (z[7] << 0x196) + (z[8] << 0x1d0)
 */
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_addcarryx_u58(uint64_t *out1, fiat_p521_uint1 *out2,
                        fiat_p521_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  uint64_t x1;
  uint64_t x2;
  fiat_p521_uint1 x3;
  x1 = ((arg1 + arg2) + arg3);
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_subborrowx_u58(uint64_t *out1, fiat_p521_uint1 *out2,
                         fiat_p521_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  int64_t x1;
  fiat_p521_int1 x2;
  uint64_t x3;
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_addcarryx_u57(uint64_t *out1, fiat_p521_uint1 *out2,
                        fiat_p521_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  uint64_t x1;
  uint64_t x2;
  fiat_p521_uint1 x3;
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_subborrowx_u57(uint64_t *out1, fiat_p521_uint1 *out2,
                         fiat_p521_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  int64_t x1;
  fiat_p521_int1 x2;
  uint64_t x3;
 ...
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_cmovznz_u64(uint64_t *out1,
                                                        fiat_p521_uint1 arg1,
                                                        uint64_t arg2,
                                                        uint64_t arg3) {
  fiat_p521_uint1 x1;
  uint64_t x2;
  ...
  x3 = ((fiat_p521_value_barrier_u64(x2) & arg3) |
        (fiat_p521_value_barrier_u64((~x2)) & arg2));
  *out1 = x3;
}
 ...
 *
 */
void fiat_p521_carry_mul(fiat_p521_tight_field_element out1,
                         const fiat_p521_loose_field_element arg1,
                         const fiat_p521_loose_field_element arg2) {
 ...
 *
 */
void fiat_p521_carry_square(fiat_p521_tight_field_element out1,
                            const fiat_p521_loose_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_carry(fiat_p521_tight_field_element out1,
                const fiat_p521_loose_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_add(fiat_p521_loose_field_element out1,
              const fiat_p521_tight_field_element arg1,
              const fiat_p521_tight_field_element arg2) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_sub(fiat_p521_loose_field_element out1,
              const fiat_p521_tight_field_element arg1,
              const fiat_p521_tight_field_element arg2) {
  uint64_t x1;
  uint64_t x2;
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_opp(fiat_p521_loose_field_element out1,
              const fiat_p521_tight_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 * 0xffffffffffffffff]]
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_selectznz(uint64_t out1[9],
                                                      fiat_p521_uint1 arg1,
...
/*
 * The function fiat_p521_to_bytes serializes a field element to bytes in
 * little-endian order.
 *
 * Postconditions:
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_to_bytes(uint8_t out1[66], const fiat_p521_tight_field_element arg1) {
  uint64_t x1;
  fiat_p521_uint1 x2;
  uint64_t x3;
  fiat_p521_uint1 x4;
  ...
  fiat_p521_subborrowx_u58(&x1, &x2, 0x0, (arg1[0]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x3, &x4, x2, (arg1[1]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x5, &x6, x4, (arg1[2]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x7, &x8, x6, (arg1[3]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x9, &x10, x8, (arg1[4]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x11, &x12, x10, (arg1[5]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x13, &x14, x12, (arg1[6]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u58(&x15, &x16, x14, (arg1[7]),
                           UINT64_C(0x3ffffffffffffff));
  fiat_p521_subborrowx_u57(&x17, &x18, x16, (arg1[8]),
                           UINT64_C(0x1ffffffffffffff));
  fiat_p521_cmovznz_u64(&x19, x18, 0x0, UINT64_C(0xffffffffffffffff));
  fiat_p521_addcarryx_u58(&x20, &x21, 0x0, x1,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x22, &x23, x21, x3,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x24, &x25, x23, x5,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x26, &x27, x25, x7,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x28, &x29, x27, x9,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x30, &x31, x29, x11,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x32, &x33, x31, x13,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u58(&x34, &x35, x33, x15,
                          (x19 & UINT64_C(0x3ffffffffffffff)));
  fiat_p521_addcarryx_u57(&x36, &x37, x35, x17,
...
/*
 * The function fiat_p521_from_bytes deserializes a field element from bytes in
 * little-endian order.
 *
 * Postconditions:
 ...
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_from_bytes(fiat_p521_tight_field_element out1,
...
/*
 * The function fiat_p521_relax is the identity function converting from tight
 * field elements to loose field elements.
 *
 * Postconditions:
 *   out1 = arg1
 *
 */
static FIAT_P521_FIAT_INLINE void
fiat_p521_relax(fiat_p521_loose_field_element out1,
                const fiat_p521_tight_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
