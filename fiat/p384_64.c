 ...
 * --static --use-value-barrier p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul
 * square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes
 * from_bytes one msat divstep divstep_precomp */
 ...
 * (z[3] << 192) + (z[4] << 256) + (z[5] << 0x140) in */
/*                            if x1 & (2^384-1) < 2^383 then x1 & (2^384-1) else
 * (x1 & (2^384-1)) - 2^384 */
...
/* The type fiat_p384_montgomery_domain_field_element is a field element in the
 * Montgomery domain. */
...
/* The type fiat_p384_non_montgomery_domain_field_element is a field element NOT
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_addcarryx_u64(uint64_t *out1, fiat_p384_uint1 *out2,
                        fiat_p384_uint1 arg1, uint64_t arg2, uint64_t arg3) {
 ...
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_subborrowx_u64(uint64_t *out1, fiat_p384_uint1 *out2,
                         fiat_p384_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  fiat_p384_int128 x1;
  fiat_p384_int1 x2;
  uint64_t x3;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_mulx_u64(uint64_t *out1,
                                                     uint64_t *out2,
                                                     uint64_t arg1,
                                                     uint64_t arg2) {
  fiat_p384_uint128 x1;
 ...
 *   out1: [0x0 ~> 0xffffffffffffffff]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_cmovznz_u64(uint64_t *out1,
                                                        fiat_p384_uint1 arg1,
                                                        uint64_t arg2,
                                                        uint64_t arg3) {
  fiat_p384_uint1 x1;
  uint64_t x2;
  ...
  x3 = ((fiat_p384_value_barrier_u64(x2) & arg3) |
        (fiat_p384_value_barrier_u64((~x2)) & arg2));
  *out1 = x3;
}
 ...
 *
 */
void fiat_p384_mul(fiat_p384_montgomery_domain_field_element out1,
                   const fiat_p384_montgomery_domain_field_element arg1,
                   const fiat_p384_montgomery_domain_field_element arg2) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *
 */
void fiat_p384_square(fiat_p384_montgomery_domain_field_element out1,
                      const fiat_p384_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_add(fiat_p384_montgomery_domain_field_element out1,
              const fiat_p384_montgomery_domain_field_element arg1,
              const fiat_p384_montgomery_domain_field_element arg2) {
  uint64_t x1;
  fiat_p384_uint1 x2;
...
/*
 * The function fiat_p384_sub subtracts two field elements in the Montgomery
 * domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_sub(fiat_p384_montgomery_domain_field_element out1,
              const fiat_p384_montgomery_domain_field_element arg1,
              const fiat_p384_montgomery_domain_field_element arg2) {
  uint64_t x1;
  fiat_p384_uint1 x2;
  ...
  fiat_p384_addcarryx_u64(&x16, &x17, x15, x3,
                          (x13 & UINT64_C(0xffffffff00000000)));
  fiat_p384_addcarryx_u64(&x18, &x19, x17, x5,
 ...
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_opp(fiat_p384_montgomery_domain_field_element out1,
              const fiat_p384_montgomery_domain_field_element arg1) {
  uint64_t x1;
  fiat_p384_uint1 x2;
  uint64_t x3;
...
/*
 * The function fiat_p384_from_montgomery translates a field element out of the
 * Montgomery domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_from_montgomery(
    fiat_p384_non_montgomery_domain_field_element out1,
    const fiat_p384_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  ...
  fiat_p384_addcarryx_u64(&x138, &x139, x137, ((uint64_t)x101 + x89),
                          (x125 + x105));
  ...
  fiat_p384_addcarryx_u64(&x188, &x189, x187, ((uint64_t)x151 + x139),
                          (x175 + x155));
  ...
  fiat_p384_addcarryx_u64(&x238, &x239, x237, ((uint64_t)x201 + x189),
                          (x225 + x205));
  ...
  fiat_p384_addcarryx_u64(&x288, &x289, x287, ((uint64_t)x251 + x239),
                          (x275 + x255));
  fiat_p384_subborrowx_u64(&x290, &x291, 0x0, x278, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u64(&x292, &x293, x291, x280,
                           UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x294, &x295, x293, x282,
                           UINT64_C(0xfffffffffffffffe));
  fiat_p384_subborrowx_u64(&x296, &x297, x295, x284,
                           UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x298, &x299, x297, x286,
                           UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x300, &x301, x299, x288,
                           UINT64_C(0xffffffffffffffff));
...
/*
 * The function fiat_p384_to_montgomery translates a field element into the
 * Montgomery domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_to_montgomery(
    fiat_p384_montgomery_domain_field_element out1,
    const fiat_p384_non_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  fiat_p384_addcarryx_u64(&x125, &x126, x124, ((uint64_t)x88 + x60),
                          (x112 + x92));
  ...
  fiat_p384_addcarryx_u64(&x191, &x192, x190, ((uint64_t)x154 + x126),
                          (x178 + x158));
  ...
  fiat_p384_addcarryx_u64(&x257, &x258, x256, ((uint64_t)x220 + x192),
                          (x244 + x224));
  ...
  fiat_p384_addcarryx_u64(&x323, &x324, x322, ((uint64_t)x286 + x258),
                          (x310 + x290));
  ...
  fiat_p384_addcarryx_u64(&x389, &x390, x388, ((uint64_t)x352 + x324),
                          (x376 + x356));
  fiat_p384_subborrowx_u64(&x391, &x392, 0x0, x379, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u64(&x393, &x394, x392, x381,
                           UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x395, &x396, x394, x383,
                           UINT64_C(0xfffffffffffffffe));
  fiat_p384_subborrowx_u64(&x397, &x398, x396, x385,
                           UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x399, &x400, x398, x387,
                           UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x401, &x402, x400, x389,
                           UINT64_C(0xffffffffffffffff));
...
/*
 * The function fiat_p384_nonzero outputs a single non-zero word if the input is
 ...
 * ~> 0xffffffffffffffff]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_nonzero(uint64_t *out1,
 ...
 * 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_selectznz(uint64_t out1[6],
                                                      fiat_p384_uint1 arg1,
...
/*
 * The function fiat_p384_to_bytes serializes a field element NOT in the
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_to_bytes(uint8_t out1[48],
                                                     const uint64_t arg1[6]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
...
/*
 * The function fiat_p384_from_bytes deserializes a field element NOT in the
 ...
 * 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_from_bytes(uint64_t out1[6],
...
/*
 * The function fiat_p384_set_one returns the field element one in the
 * Montgomery domain.
 *
 * Postconditions:
 ...
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_set_one(fiat_p384_montgomery_domain_field_element out1) {
...
/*
 * The function fiat_p384_msat returns the saturated representation of the prime
 * modulus.
 *
 * Postconditions:
 ...
 */
static FIAT_P384_FIAT_INLINE void
fiat_p384_divstep(uint64_t *out1, uint64_t out2[7], uint64_t out3[7],
                  uint64_t out4[6], uint64_t out5[6], uint64_t arg1,
                  const uint64_t arg2[7], const uint64_t arg3[7],
                  const uint64_t arg4[6], const uint64_t arg5[6]) {
  uint64_t x1;
  fiat_p384_uint1 x2;
  fiat_p384_uint1 x3;
  uint64_t x4;
  ...
  x3 = (fiat_p384_uint1)((fiat_p384_uint1)(x1 >> 63) &
                         (fiat_p384_uint1)((arg3[0]) & 0x1));
  ...
  fiat_p384_addcarryx_u64(&x88, &x89, x87, x75,
                          (x85 & UINT64_C(0xffffffff00000000)));
  fiat_p384_addcarryx_u64(&x90, &x91, x89, x77,
  ...
  fiat_p384_subborrowx_u64(&x146, &x147, x145, x134,
                           UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x148, &x149, x147, x136,
                           UINT64_C(0xfffffffffffffffe));
  fiat_p384_subborrowx_u64(&x150, &x151, x149, x138,
                           UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x152, &x153, x151, x140,
                           UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x154, &x155, x153, x142,
                           UINT64_C(0xffffffffffffffff));
...
/*
 * The function fiat_p384_divstep_precomp returns the precomputed value for
