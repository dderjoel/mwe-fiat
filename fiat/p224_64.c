 ...
 * --static --use-value-barrier p224 64 '2^224 - 2^96 + 1' mul square add sub
...
/* The type fiat_p224_montgomery_domain_field_element is a field element in the
 * Montgomery domain. */
...
/* The type fiat_p224_non_montgomery_domain_field_element is a field element NOT
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_addcarryx_u64(uint64_t *out1, fiat_p224_uint1 *out2,
                        fiat_p224_uint1 arg1, uint64_t arg2, uint64_t arg3) {
 ...
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_subborrowx_u64(uint64_t *out1, fiat_p224_uint1 *out2,
                         fiat_p224_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  fiat_p224_int128 x1;
  fiat_p224_int1 x2;
  uint64_t x3;
 ...
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_mulx_u64(uint64_t *out1,
                                                     uint64_t *out2,
                                                     uint64_t arg1,
                                                     uint64_t arg2) {
  fiat_p224_uint128 x1;
 ...
 *   out1: [0x0 ~> 0xffffffffffffffff]
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_cmovznz_u64(uint64_t *out1,
                                                        fiat_p224_uint1 arg1,
                                                        uint64_t arg2,
                                                        uint64_t arg3) {
  fiat_p224_uint1 x1;
  uint64_t x2;
  ...
  x3 = ((fiat_p224_value_barrier_u64(x2) & arg3) |
        (fiat_p224_value_barrier_u64((~x2)) & arg2));
  *out1 = x3;
}
 ...
 *
 */
void fiat_p224_mul(fiat_p224_montgomery_domain_field_element out1,
                   const fiat_p224_montgomery_domain_field_element arg1,
                   const fiat_p224_montgomery_domain_field_element arg2) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *
 */
void fiat_p224_square(fiat_p224_montgomery_domain_field_element out1,
                      const fiat_p224_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
 ...
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_add(fiat_p224_montgomery_domain_field_element out1,
              const fiat_p224_montgomery_domain_field_element arg1,
              const fiat_p224_montgomery_domain_field_element arg2) {
  uint64_t x1;
  fiat_p224_uint1 x2;
...
/*
 * The function fiat_p224_sub subtracts two field elements in the Montgomery
 * domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_sub(fiat_p224_montgomery_domain_field_element out1,
              const fiat_p224_montgomery_domain_field_element arg1,
              const fiat_p224_montgomery_domain_field_element arg2) {
  uint64_t x1;
  fiat_p224_uint1 x2;
  ...
  fiat_p224_addcarryx_u64(&x12, &x13, x11, x3,
 ...
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_opp(fiat_p224_montgomery_domain_field_element out1,
              const fiat_p224_montgomery_domain_field_element arg1) {
  uint64_t x1;
  fiat_p224_uint1 x2;
  uint64_t x3;
...
/*
 * The function fiat_p224_from_montgomery translates a field element out of the
 * Montgomery domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 *
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_from_montgomery(
    fiat_p224_non_montgomery_domain_field_element out1,
    const fiat_p224_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  ...
  fiat_p224_subborrowx_u64(&x103, &x104, x102, x96,
                           UINT64_C(0xffffffff00000000));
  fiat_p224_subborrowx_u64(&x105, &x106, x104, x98,
                           UINT64_C(0xffffffffffffffff));
...
/*
 * The function fiat_p224_to_montgomery translates a field element into the
 * Montgomery domain.
 *
 * Preconditions:
 *   0 ≤ eval arg1 < m
 ...
 *
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_to_montgomery(
    fiat_p224_montgomery_domain_field_element out1,
    const fiat_p224_non_montgomery_domain_field_element arg1) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  fiat_p224_addcarryx_u64(&x59, &x60, x58, ((x38 + (x18 + x6)) + (x30 + x22)),
                          x51);
  ...
  fiat_p224_addcarryx_u64(&x101, &x102, x100,
                          ((x80 + (x60 + (x52 + x40))) + (x72 + x64)), x93);
  ...
  fiat_p224_addcarryx_u64(&x143, &x144, x142,
                          ((x122 + (x102 + (x94 + x82))) + (x114 + x106)),
                          x135);
  ...
  fiat_p224_subborrowx_u64(&x168, &x169, x167, x161,
                           UINT64_C(0xffffffff00000000));
  fiat_p224_subborrowx_u64(&x170, &x171, x169, x163,
                           UINT64_C(0xffffffffffffffff));
...
/*
 * The function fiat_p224_nonzero outputs a single non-zero word if the input is
 ...
 * ~> 0xffffffffffffffff]
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_nonzero(uint64_t *out1,
 ...
 * 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_selectznz(uint64_t out1[4],
                                                      fiat_p224_uint1 arg1,
...
/*
 * The function fiat_p224_to_bytes serializes a field element NOT in the
 ...
 * Input Bounds:
 *   arg1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
 * 0xffffffffffffffff], [0x0 ~> 0xffffffff]] Output Bounds: out1: [[0x0 ~>
 ...
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_to_bytes(uint8_t out1[28],
                                                     const uint64_t arg1[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
...
/*
 * The function fiat_p224_from_bytes deserializes a field element NOT in the
 ...
 */
static FIAT_P224_FIAT_INLINE void fiat_p224_from_bytes(uint64_t out1[4],
                                                       const uint8_t arg1[28]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint8_t x4;
...
/*
 * The function fiat_p224_set_one returns the field element one in the
 * Montgomery domain.
 *
 * Postconditions:
 ...
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_set_one(fiat_p224_montgomery_domain_field_element out1) {
...
/*
 * The function fiat_p224_msat returns the saturated representation of the prime
 * modulus.
 *
 * Postconditions:
 ...
 */
static FIAT_P224_FIAT_INLINE void
fiat_p224_divstep(uint64_t *out1, uint64_t out2[5], uint64_t out3[5],
                  uint64_t out4[4], uint64_t out5[4], uint64_t arg1,
                  const uint64_t arg2[5], const uint64_t arg3[5],
                  const uint64_t arg4[4], const uint64_t arg5[4]) {
  uint64_t x1;
  fiat_p224_uint1 x2;
  fiat_p224_uint1 x3;
  uint64_t x4;
  ...
  x3 = (fiat_p224_uint1)((fiat_p224_uint1)(x1 >> 63) &
                         (fiat_p224_uint1)((arg3[0]) & 0x1));
  ...
  fiat_p224_addcarryx_u64(&x64, &x65, x63, x55,
                          (x61 & UINT64_C(0xffffffff00000000)));
  ...
  fiat_p224_subborrowx_u64(&x104, &x105, x103, x96,
                           UINT64_C(0xffffffff00000000));
  fiat_p224_subborrowx_u64(&x106, &x107, x105, x98,
                           UINT64_C(0xffffffffffffffff));
...
/*
 * The function fiat_p224_divstep_precomp returns the precomputed value for
